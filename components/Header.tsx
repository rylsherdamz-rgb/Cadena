...
export default function Header() {
  ...
  return (
    <div 
      ...
      // Added py-12 md:py-0 to handle vertical scrolling on small phones
    ...
    >
      ...
      {/* Image Section */}
      <div className="w-full md:w-2/5 lg:w-1/2 flex justify-center items-center mt-8 md:mt-0">
        <div 
          ref={imageRef}
          // Responsive width/height using max-w and aspect ratio
